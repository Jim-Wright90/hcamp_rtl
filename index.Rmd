...
### Visual Relationships {.tabset .tabset-fade .tabset-pills}

```{r, include=FALSE}


ggplot(final_rtl_rtp_data_3, aes(total_symptom_score, onset_rtp_total_days)) +
  geom_point() +
  geom_smooth() +
  theme(plot.title = element_text(hjust = 0.5)) +
...
symptom_day_scatter <- function(df, x, y) {
  ggplot(df, aes({{x}}, {{y}})) +
  geom_point() +
  geom_smooth() +
  labs(x = "Symptom Score",
...
symptom_day_scatter(final_rtl_rtp_data_3, total_symptom_score, onset_rtp_total_days) +
  labs(title = "PCSS Total Symptom Score")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, headache_migraine_cluster_score, onset_rtp_total_days) +
  labs(title = "Headache-Migraine Cluster")
```

#### Cognitive Symptoms Cluster

```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, cognitive_cluster_score, onset_rtp_total_days) +
  labs(title = "Cognitive Cluster")
```

#### Anxiety-Mood Symptoms Cluster

```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, anxiety_mood_cluster_score, onset_rtp_total_days) +
  labs(title = "Anxiety-Mood Cluster")
```

#### Ocular-Motor Symptoms Cluster

```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, ocular_motor_cluster_score, onset_rtp_total_days) +
  labs(title = "Ocular-Motor Cluster")
```

#### Vestibular Symptoms Cluster

```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, vestibular_cluster_score, onset_rtp_total_days) +
  labs(title = "Vestibular Cluster")
```

#### Sleep Symptoms Cluster

```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, sleep_cluster_score, onset_rtp_total_days) +
  labs(title = "Sleep Cluster")
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$total_symptom_score, final_rtl_rtp_data_3$onset_rtp_total_days)
```

#### Headache-Migraine Symptoms Cluster

```{r, include=TRUE}
cor(final_rtl_rtp_data_3$headache_migraine_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```

#### Cognitive Symptoms Cluster

```{r, include=TRUE}
cor(final_rtl_rtp_data_3$cognitive_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$anxiety_mood_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$ocular_motor_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$vestibular_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$sleep_cluster_score, 
    final_rtl_rtp_data_3$onset_rtp_total_days)
```
...
rtp_coor_df <- data.frame("pcss_level" = c("Total Symptom Score",
                                           "Headache-Migraine Symptoms Cluster",
                                           "Cognitive Symptoms Cluster",
                                           "Anxiety-Mood Symptoms Cluster",
                                           "Ocular-Motor Symptoms Cluster",
...
rtp_coor_tbl <- rtp_coor_df %>% 
  reactable(
    columns = list(
      pcss_level = colDef(name = "PCSS Level",
                          align = "center"),
      coorrelation_value = colDef(name = "Coorrelation Value",
                                  align = "center",
                                    style = function(value) {
                                      normalized <- (value - min(rtp_coor_df$coorrelation_value)) / (max(rtp_coor_df$coorrelation_value) - min(rtp_coor_df$coorrelation_value))
...
```{r, include=FALSE}
ggplot(final_rtl_rtp_data_3, aes(sample = onset_rtp_total_days)) +
  stat_qq_line(color = "#56B4E9") +
  geom_qq(color = "gray40")

qq_norm <- function(df, x) {
  ggplot(df, aes(sample = {{x}})) +
  stat_qq_line(color = "#56B4E9") +
  geom_qq(color = "gray40")
}

qq_norm(final_rtl_rtp_data_3, onset_rtp_total_days)
```
...
```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, total_symptom_score)
```

#### Headache-Migraine Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, headache_migraine_cluster_score)
```

#### Cognitive Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, cognitive_cluster_score)
```

#### Anxiety-Mood Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, anxiety_mood_cluster_score)
```

#### Ocular-Motor Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, ocular_motor_cluster_score)
```

#### Vestibular Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, vestibular_cluster_score)
```

#### Sleep Symptoms Cluster

```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, sleep_cluster_score)
```

### Models {.tabset .tabset-fade .tabset-pills}

```{r, include=FALSE}
model_data <- final_rtl_rtp_data_3 %>% 
  mutate(age = as.factor(age))

model_data <- model_data %>% 
  rename_at(.vars = vars(ends_with("_cluster_score")),
            .funs = funs(sub("_cluster_score", "", .)))

total_symptom_model_1 <- lm(onset_rtp_total_days ~ total_symptom_score, data = model_data)

arm::display(total_symptom_model_1)
summary(total_symptom_model_1)


gender_only_model <- lm(onset_rtp_total_days ~ gender, data = model_data)

summary(gender_only_model)

anova(total_symptom_model_1, gender_only_model)

sundry::aic_weights(total_symptom_model_1, gender_only_model)

# Symptom score better fit than gender

age_only_model <- lm(onset_rtp_total_days ~ age, data = model_data)

summary(age_only_model)


total_symptom_model_gender <- lm(onset_rtp_total_days ~ total_symptom_score + gender,
                                 data = model_data)

summary(total_symptom_model_gender)

total_symptom_model_age <- lm(onset_rtp_total_days ~ total_symptom_score + age,
                                 data = model_data)

summary(total_symptom_model_age)

summary(total_symptom_model_1)$r.squared
summary(total_symptom_model_gender)$r.squared
summary(total_symptom_model_age)$r.squared

summary(total_symptom_model_gender)$r.squared - summary(total_symptom_model_1)$r.squared

anova(total_symptom_model_1, total_symptom_model_age, total_symptom_model_gender)

sundry::aic_weights(total_symptom_model_1, total_symptom_model_gender, total_symptom_model_age, gender_only_model)

# Total symptoms still seem like best model - age doesn't appear to be a major factor


#Individual symptom cluster long way

cluster_mod_1 <- lm(onset_rtp_total_days ~ headache_migraine, data = model_data)
summary(cluster_mod_1)

cluster_mod_2 <- lm(onset_rtp_total_days ~ cognitive, data = model_data)
summary(cluster_mod_2)

cluster_mod_3 <- lm(onset_rtp_total_days ~ anxiety_mood, data = model_data)
summary(cluster_mod_3)

cluster_mod_4 <- lm(onset_rtp_total_days ~ ocular_motor, data = model_data)
summary(cluster_mod_4)

cluster_mod_5 <- lm(onset_rtp_total_days ~ vestibular, data = model_data)
summary(cluster_mod_5)

cluster_mod_6 <- lm(onset_rtp_total_days ~ sleep, data = model_data)
summary(cluster_mod_6)


sundry::aic_weights(cluster_mod_1,
                    cluster_mod_2,
                    cluster_mod_3,
                    cluster_mod_4,
                    cluster_mod_5,
...
# Ocular-motor (4) and cognitive (2) appear to be best models 
```

```{r, include=FALSE}
#purr approach 

symptom_cluster_data_long <- model_data %>% 
  pivot_longer(
    cols = c(58:63),
...
by_cluster <- split(symptom_cluster_data_long, symptom_cluster_data_long$symptom_cluster)
  
str(by_cluster)

mods <- map(by_cluster, ~lm(onset_rtp_total_days ~ cluster_score, data = .x))
...
```{r, include=FALSE}
#list column approach with gender 

mods_list_column <- model_data %>% 
  nest(-gender) %>% 
  mutate(m1 = map(data, ~lm(onset_rtp_total_days ~ headache_migraine, data = .x)),
         m2 = map(data, ~lm(onset_rtp_total_days ~ cognitive, data = .x)),
         m3 = map(data, ~lm(onset_rtp_total_days ~ anxiety_mood, data = .x)),
         m4 = map(data, ~lm(onset_rtp_total_days ~ ocular_motor, data = .x)),
         m5 = map(data, ~lm(onset_rtp_total_days ~ vestibular, data = .x)),
         m6 = map(data, ~lm(onset_rtp_total_days ~ sleep, data = .x)))

mods_list_column

mods_list_column$m1[[1]]
mods_list_column$m2[[1]]
mods_list_column$m3[[1]]
mods_list_column$m4[[1]]
mods_list_column$m5[[1]]
mods_list_column$m6[[1]]

compare_1 <- anova(mods_list_column$m2[[1]], mods_list_column$m4[[1]])
compare_1
...
mods_list_column %>%
    pivot_longer(m1:m6, names_to = "model", values_to = "output") %>% 
...
cognitive_ocular_motor_rtp_mod <- lm(onset_rtp_total_days ~ cognitive + ocular_motor, 
                                     data = model_data)
...
```{r, include=TRUE}
summary(cognitive_ocular_motor_rtp_mod)
```
...
```{r, include=TRUE}
sundry::aic_weights(cluster_mod_2, cluster_mod_4, cognitive_ocular_motor_rtp_mod)
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, total_symptom_score, onset_rtl_total_days) +
  labs(title = "PCSS Total Symptom Score")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, headache_migraine_cluster_score, onset_rtl_total_days) +
  labs(title = "Headache-Migraine Cluster")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, cognitive_cluster_score, onset_rtl_total_days) +
  labs(title = "Cognitive Cluster")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, anxiety_mood_cluster_score, onset_rtl_total_days) +
  labs(title = "Anxiety-Mood Cluster")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, ocular_motor_cluster_score, onset_rtl_total_days) +
  labs(title = "Ocular-Motor Cluster")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, vestibular_cluster_score, onset_rtl_total_days) +
  labs(title = "Vestibular Cluster")
```
...
```{r, include=TRUE}
symptom_day_scatter(final_rtl_rtp_data_3, sleep_cluster_score, onset_rtl_total_days) +
  labs(title = "Sleep Cluster")
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$total_symptom_score, final_rtl_rtp_data_3$onset_rtl_total_days)
```
...
```{r, include=TRUE}
cor(final_rtl_rtp_data_3$headache_migraine_cluster_score, 
    final_rtl_rtp_data_3$onset_rtl_total_days)
```
...
rtl_coor_df <- data.frame("pcss_level" = c("Total Symptom Score",
                                           "Headache-Migraine Symptoms Cluster",
                                           "Cognitive Symptoms Cluster",
                                           "Anxiety-Mood Symptoms Cluster",
                                           "Ocular-Motor Symptoms Cluster",
  ...
  reactable(
    columns = list(
      ...
      coorrelation_value = colDef(name = "Coorrelation Value",
                                  align = "center",
                                    style = function(value) {
                                      normalized <- (value - min(rtl_coor_df$coorrelation_value)) / (max(rtl_coor_df$coorrelation_value) - min(rtl_coor_df$coorrelation_value))
                                      color <- orange_pal(normalized)
                                      list(background = color)
                                    }
                                      )),
...
```{r, include=TRUE}
qq_norm(final_rtl_rtp_data_3, onset_rtl_total_days)
```
...
```{r, include=FALSE}
total_symptom_model_2 <- lm(onset_rtl_total_days ~ total_symptom_score, data = model_data)

arm::display(total_symptom_model_2)
summary(total_symptom_model_2)


rtl_gender_only_model <- lm(onset_rtl_total_days ~ gender, data = model_data)

summary(rtl_gender_only_model)

anova(total_symptom_model_2, rtl_gender_only_model)

sundry::aic_weights(total_symptom_model_2, rtl_gender_only_model)

# gender better fit than total symptom score

rtl_age_only_model <- lm(onset_rtl_total_days ~ age, data = model_data)

summary(rtl_age_only_model)


rtl_total_symptom_model_gender <- lm(onset_rtl_total_days ~ total_symptom_score + gender,
                                 data = model_data)

summary(rtl_total_symptom_model_gender)

rtl_total_symptom_model_age <- lm(onset_rtl_total_days ~ total_symptom_score + age,
                                 data = model_data)

summary(rtl_total_symptom_model_age)

summary(total_symptom_model_2)$r.squared
summary(rtl_total_symptom_model_gender)$r.squared
summary(rtl_total_symptom_model_age)$r.squared

summary(rtl_total_symptom_model_gender)$r.squared - summary(total_symptom_model_2)$r.squared


sundry::aic_weights(total_symptom_model_2,
                    rtl_total_symptom_model_gender,
                    rtl_total_symptom_model_age,
                    rtl_gender_only_model)

# gender strongest predictor of RTL 


#Individual symptom cluster long way

rtl_cluster_mod_1 <- lm(onset_rtl_total_days ~ headache_migraine, data = model_data)
summary(rtl_cluster_mod_1)

rtl_cluster_mod_2 <- lm(onset_rtl_total_days ~ cognitive, data = model_data)
summary(rtl_cluster_mod_2)

rtl_cluster_mod_3 <- lm(onset_rtl_total_days ~ anxiety_mood, data = model_data)
summary(rtl_cluster_mod_3)

rtl_cluster_mod_4 <- lm(onset_rtl_total_days ~ ocular_motor, data = model_data)
summary(rtl_cluster_mod_4)

rtl_cluster_mod_5 <- lm(onset_rtl_total_days ~ vestibular, data = model_data)
summary(rtl_cluster_mod_5)

rtl_cluster_mod_6 <- lm(onset_rtl_total_days ~ sleep, data = model_data)
summary(rtl_cluster_mod_6)


sundry::aic_weights(rtl_cluster_mod_1,
                    rtl_cluster_mod_2,
                    rtl_cluster_mod_3,
                    rtl_cluster_mod_4,
                    rtl_cluster_mod_5,
...
# cognitive model best for predicting RTL duration 
