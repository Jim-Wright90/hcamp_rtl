...
symptom_scatter(impact_post_injury_1, total_symptom_score, verbal_memory)
```
...
```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_somatic_symptom_score, verbal_memory)
```

#### PCSS Psychological Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_psychological_symptom_score, verbal_memory)
```

#### PCSS Cognitive Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_cognitive_symptom_score, verbal_memory)
```
...
```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_symptom_score, visual_memory)
```

#### PCSS Somatic Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_somatic_symptom_score, visual_memory)
```

#### PCSS Psychological Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_psychological_symptom_score, visual_memory)
```

#### PCSS Cognitive Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_cognitive_symptom_score, visual_memory)
```
...
```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_symptom_score, visual_motor)
```

#### PCSS Somatic Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_somatic_symptom_score, visual_motor)
```

#### PCSS Psychological Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_psychological_symptom_score, visual_motor)
```

#### PCSS Cognitive Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_cognitive_symptom_score, visual_motor)
```
...
```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_symptom_score, impulse_control)
```

#### PCSS Somatic Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_somatic_symptom_score, impulse_control)
```

#### PCSS Psychological Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_psychological_symptom_score, impulse_control)
```

#### PCSS Cognitive Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_cognitive_symptom_score, impulse_control)
```
...
```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_symptom_score, reaction_time)
```

#### PCSS Somatic Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_somatic_symptom_score, reaction_time)
```

#### PCSS Psychological Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_psychological_symptom_score, reaction_time)
```

#### PCSS Cognitive Symptom Score Comparison

```{r, include=TRUE}
symptom_scatter(impact_post_injury_1, total_cognitive_symptom_score, reaction_time)
```

## Post-Injury 1 ImPACT and PCSS Descriptive Statistics {.tabset .tabset-fade .tabset-pills}

```{r, include=FALSE}
create_react_score <- function(df, var) {
    df %>% 
      summarize(Mean = mean({{var}}),
                SD = sd({{var}}),
                Min = min({{var}}),
...
### ImPACT {.tabset .tabset-fade .tabset-pills}

#### Verbal Memory Summary

```{r, include=TRUE}
create_react_score(impact_post_injury_1, verbal_memory)
```

#### Verbal Memory Distribution

```{r, include=TRUE}
score_hist(impact_post_injury_1, verbal_memory)
```

#### Visual Memory Summary

```{r, include=TRUE}
create_react_score(impact_post_injury_1, visual_memory)
```

#### Visual Memory Distribution

```{r, include=TRUE}
score_hist(impact_post_injury_1, visual_memory)
```

#### Visual Motor Summary

```{r, include=TRUE}
create_react_score(impact_post_injury_1, visual_motor)
```

#### Visual Motor Distribution

```{r, include=TRUE}
score_hist(impact_post_injury_1, visual_motor)
```


#### Impulse Control Summary

```{r, include=TRUE}
create_react_score(impact_post_injury_1, impulse_control)
```

#### Impulse Control Distribution

```{r, include=TRUE}
score_hist(impact_post_injury_1, impulse_control)
```

#### Reaction Time Summary

```{r, include=TRUE}
create_react_score(impact_post_injury_1, reaction_time)
```

#### Reaction Time Distribution

```{r, include=TRUE}
score_hist(impact_post_injury_1, reaction_time)
```


### PCSS {.tabset .tabset-fade .tabset-pills}

* Total Symptom Score: 22 items (Total possible score of 132)
* Total Somatic Symptom Score: 13 items (Total possible score 78)
* Total Psychological Symptom Score: 5 items (Total possible score of 30)
* Total Cognitive Symptom Score: 4 items (Total possible score of 24)

#### Total Symptom Score

```{r, include=TRUE}
create_react_score(impact_post_injury_1, total_symptom_score)
```

#### Total Symptom Distribution 

```{r, include=TRUE}
score_hist(impact_post_injury_1, total_symptom_score)
```

#### Somatic Symptom Score

```{r, include=TRUE}
create_react_score(impact_post_injury_1, total_somatic_symptom_score)
```

#### Somatic Symptom Distribution 

```{r, include=TRUE}
score_hist(impact_post_injury_1, total_somatic_symptom_score)
```

#### Psychological Symptom Score

```{r, include=TRUE}
create_react_score(impact_post_injury_1, total_psychological_symptom_score)
```

#### Psychological Symptom Distribution 

```{r, include=TRUE}
score_hist(impact_post_injury_1, total_psychological_symptom_score)
```

#### Cognitive Symptom Score

```{r, include=TRUE}
create_react_score(impact_post_injury_1, total_cognitive_symptom_score)
```

#### Cognitive Symptom Distribution 

```{r, include=TRUE}
score_hist(impact_post_injury_1, total_cognitive_symptom_score)
```